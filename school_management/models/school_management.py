...
class SchoolManagement(models.Model):
    ...
    # this is for make a draggable tree view item
    sequence_drg = fields.Integer(string="Drag Me")
    ...
    mentor = fields.Many2many('teacher.management', string="Mentor Name")
    country = fields.Many2one('res.country')
    books = fields.One2many(
        'school.management.books', 'book_fields', string='Books')

    # status bar
    status = fields.Selection([('active', 'Active'), ('saved', 'Saved')],
                              string="Status", readonly=True, default="active")
    ...
    def create(self, vals):
        ...
        record.write({'enr_number': "ENR" + str(record.id).zfill(3)})
...
# this is for updated li
    ...
    # this is related fields
    zip = fields.Char(string="Zip/Postal Code", related='country.code')
...
# this is for updated li
    ...
    # this button is pass the simple value in console
    def print_btn(self):
        print("This is object button which is called by function")

    # this is help to delete the bookdetails
            ...
            if records.books:
                ...
                return {
                    'effect': {
                        'fadeout': 'slow',
                        'type': 'rainbow_man',
                        'message': 'The Details of Book is Deleted'
...
class SchoolManagementBooks(models.Model):
    _name = "school.management.books"

    book_fields = fields.Many2one('school.management', string="Book Fields")
    name = fields.Char(string="Book Name")
    author = fields.Char(string="Author")
    book_type = fields.Many2one('product.product', string="Book Type")
    sequence_drg = fields.Integer(string="Drag me")
